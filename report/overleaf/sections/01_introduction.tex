...
des r\'esultats mesurables. L'interface Streamlit est impl\'ement\'ee ; sa validation finale et la
pr\'eparation de la d\'emonstration orale font l'objet d'un travail en cours (voir
section~\ref{sec:etat}). Le rapport est organis\'e comme suit :
