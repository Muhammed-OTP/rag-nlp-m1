...
\subsubsection{Streamlit (valid\'ee)}

L'application \texttt{app.py} a \'et\'e test\'ee avec succ\`es (\texttt{streamlit run app.py}).
Les questions pos\'ees via l'onglet Chat produisent des r\'eponses pr\'ecises, correctement
ancr\'ees dans les chunks sources affich\'es (temps de r\'eponse, score de fid\'elit\'e et
similarit\'e inclus). L'interface est organis\'ee en trois onglets :
\begin{itemize}[noitemsep]
...
de similarit\'e. Cette interface constitue le point d'entr\'ee pr\'evu pour la d\'emonstration
orale du 15 juin 2026.
